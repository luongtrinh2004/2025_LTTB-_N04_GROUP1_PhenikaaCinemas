...
class VanMayDetailPage extends StatefulWidget {
  const VanMayDetailPage({super.key});

  @override
  State<VanMayDetailPage> createState() =>
      _VanMayDetailPageState();
}

class _VanMayDetailPageState
    extends State<VanMayDetailPage> {
  // Ảnh
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Gabriel, một thiên thần thừa lòng tốt nhưng thiếu kỹ năng, tự dưng đi can thiệp vào cuộc sống '
            'của một anh nhân viên thời vụ và một đại gia đầu tư mạo hiểm, rồi làm rối tung rối mù hết cả lên.',
          ),
