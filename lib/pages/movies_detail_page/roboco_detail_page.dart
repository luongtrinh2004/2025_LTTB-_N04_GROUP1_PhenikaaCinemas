...
class RobocoDetailPage extends StatelessWidget {
  const RobocoDetailPage({super.key});

  @override
  Widget build(BuildContext context) {
    const poster = 'img/roboco.jpg';
    const stills = [
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            ...
            'Thế nhưng, điều xuất hiện trước cửa nhà cậu lại là Roboco – cô hầu gái hậu đậu nhưng sở hữu sức mạnh vô đối.'
            'Tưởng như chỉ là những ngày thường nhật đầy rắc rối, nhưng một thế lực giấu mặt đã bóp méo các chiều không gian, khiến vô số bản thể Robocon mắc kẹt tại Trái Đất.'
            'Cuộc chiến đa vũ trụ bùng nổ, nơi Bondo và Roboco cùng mọi người phải hợp sức vạch trần ác nhân và bảo vệ những kẻ yếu thế...',
          ),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
                child: Text(
                    'Ngôn ngữ: Tiếng Nhật, Phụ Đề/Lồng Tiếng Tiếng Việt và Tiếng Anh')),
          ],
        ),
      ],
    );
