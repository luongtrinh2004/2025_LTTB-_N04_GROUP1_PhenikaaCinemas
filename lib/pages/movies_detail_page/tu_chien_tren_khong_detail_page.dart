...
class TuChienTrenKhongDetailPage extends StatefulWidget {
  const TuChienTrenKhongDetailPage({super.key});

  @override
  State<TuChienTrenKhongDetailPage> createState() =>
      _TuChienTrenKhongDetailPageState();
}

class _TuChienTrenKhongDetailPageState
    extends State<TuChienTrenKhongDetailPage> {
  // Ảnh (khớp asset bạn dùng ở HomePage)
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => BookingPage(
                      movieTitle: 'Tử Chiến Trên Không',
