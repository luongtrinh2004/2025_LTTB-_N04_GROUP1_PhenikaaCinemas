...
class RobocoDetailPageEn extends StatefulWidget {
  const RobocoDetailPageEn({super.key});

  @override
  State<RobocoDetailPageEn> createState() => _RobocoDetailPageEnState();
}

class _RobocoDetailPageEnState extends State<RobocoDetailPageEn> {
  // Images
  ...
  final Map<String, Map<String, int>> _remainingByDateTime = const {
    'Today': {'09:00': 60, '14:30': 35, '18:45': 12, '22:15': 70},
    'Tomorrow': {'09:00': 75, '14:30': 40, '18:45': 20, '22:15': 81},
    'Saturday': {'09:00': 30, '14:30': 22, '18:45': 10, '22:15': 18},
  };
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'In the year 20XX, Bondo wishes for a cool robot friend — but what arrives is Roboco, a clumsy yet unbelievably powerful maid. '
            'A mysterious force warps dimensions, trapping countless Roboco variants on Earth. '
            'Bondo, Roboco, and their friends must team up to unmask the villain and protect those who can’t protect themselves.',
          ),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) => BookingPageEn(
                      movieTitle: 'Me & Roboco: Super Multiverse',
      ...
      children: [
        ...
        Row(
          children: [
            ...
            SizedBox(width: 6),
            Text('8.2 / 10', style: TextStyle(fontWeight: FontWeight.w600)),
            SizedBox(width: 12),
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(width: 6),
            Expanded(
              child: Text('Languages: Japanese; Sub/Dub: Vietnamese & English'),
            ),
          ],
        ),
      ],
