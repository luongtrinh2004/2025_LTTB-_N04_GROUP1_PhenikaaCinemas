// lib/pages/english/movies_detail_page/cai_ma_detail_page_en.dart
...
class CaiMaDetailPageEn extends StatefulWidget {
  const CaiMaDetailPageEn({super.key});

  @override
  State<CaiMaDetailPageEn> createState() => _CaiMaDetailPageEnState();
}

class _CaiMaDetailPageEnState extends State<CaiMaDetailPageEn> {
  // Assets
  static const poster = 'img/caima.jpg';
  // TODO: replace with real behind-the-scenes stills if available
  static const stills = ['img/caima.jpg', 'img/caima.jpg', 'img/caima.jpg'];
  ...
  final Map<String, Map<String, int>> _remainingByDateTime = const {
    'Today': {'11:00': 50, '14:15': 32, '17:40': 16, '21:00': 72},
    'Tomorrow': {'11:00': 60, '14:15': 40, '17:40': 24, '21:00': 80},
    'Sat': {'11:00': 28, '14:15': 18, '17:40': 10, '21:00': 22},
  };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const AppHeader(), // header giữ nguyên
      body: ListView(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: const [_Tag('Horror'), _Tag('Survival'), _Tag('16+')],
          ),
          ...
          const SizedBox(height: 8),
          const Text(
            'When Mr. Quang’s extended family returns to their hometown to perform a long-delayed reburial ritual, '
            'they confront not only the spiritual rites themselves, but also the awakening of a generational cycle of karmic consequence.',
          ),
          ...
          // Book button -> BookingPage (VN) with selected date/time
          SizedBox(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(width: 6),
            Expanded(child: Text('Language: Vietnamese')),
          ],
        ),
      ],
    );
