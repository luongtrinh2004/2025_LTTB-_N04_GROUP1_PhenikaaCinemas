// lib/pages/english/movies_detail_page/avatar3_detail_page_en.dart
...
class Avatar3DetailPageEn extends StatefulWidget {
  ...
  @override
  State<Avatar3DetailPageEn> createState() => _Avatar3DetailPageEnState();
}
...
class _Avatar3DetailPageEnState extends State<Avatar3DetailPageEn> {
  ...
  // room capacity & remaining seats by date-time (demo)
  final int _roomCapacity = 120;
  final Map<String, Map<String, int>> _remainingByDateTime = {
    'Today': {'09:00': 64, '14:30': 28, '18:45': 12, '22:15': 80},
    'Tomorrow': {'09:00': 72, '14:30': 46, '18:45': 20, '22:15': 95},
    'Sat': {'09:00': 35, '14:30': 18, '18:45': 8, '22:15': 22},
  };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // Header giữ nguyên như bản VN (không avatar bên phải)
      ...
      body: ListView(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: const [_Tag('Action'), _Tag('Fantasy'), _Tag('16+')],
          ),
          ...
          const SizedBox(height: 8),
          const Text(
            "Avatar 3: The Seed Bearer continues the journey of Jake Sully's family after "
            "the events of The Way of Water. This time, they grapple with inner conflict "
            "following Neteyam’s death and encounter a new Na’vi clan: the Fire/Ash People.",
          ),
          ...
          const SizedBox(height: 8),
          Text(
            '$_seatsLeft / $_roomCapacity seats left for ${_selectedTime.toString()} • ${_selectedDate.toString()}',
          ...
          // Book button -> BookingPage with selected date/time
          SizedBox(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(width: 6),
            Expanded(child: Text('Languages: English (Vietnamese subtitles)')),
          ],
        ),
      ],
    );
