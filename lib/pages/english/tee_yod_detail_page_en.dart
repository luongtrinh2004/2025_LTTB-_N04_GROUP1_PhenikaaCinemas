...
class TeeYodDetailPageEn extends StatefulWidget {
  const TeeYodDetailPageEn({super.key});

  @override
  State<TeeYodDetailPageEn> createState() => _TeeYodDetailPageEnState();
}

class _TeeYodDetailPageEnState extends State<TeeYodDetailPageEn> {
  // Images (keep same asset names as HomePage)
  ...
  final Map<String, Map<String, int>> _remainingByDateTime = const {
    'Today': {'11:00': 64, '14:15': 28, '17:40': 12, '21:00': 80},
    'Tomorrow': {'11:00': 72, '14:15': 46, '17:40': 20, '21:00': 95},
    'Saturday': {'11:00': 35, '14:15': 18, '17:40': 8, '21:00': 22},
  };
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'A chilling legend awakens. A group of friends accidentally encounter “Tee Yod” '
            'and must fight to survive before it is too late.',
          ),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(width: 6),
            Expanded(
              child: Text('Language: Thai; Subtitles: Vietnamese'),
            ),
          ],
        ),
      ],
